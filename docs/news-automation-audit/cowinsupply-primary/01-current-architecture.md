...
- Persistent candidates, run records, state and locks use site-prefixed `news-automation-v3` keys. The current policy migration is recorded as `v4` without deleting historical records.
