export const SEO_CLEANUP_VERSION = "2026-08-content-quality-v1";
...
export function isRemovedNewsSlug(slug) {
  return isAutoTemplateNews({ content: "", sourceUrl: "", sourcePublisher: "" }) || LEGACY_NEWS_REDIRECTS.has(String(slug || ""));
}
...
export function contentCleanupPlan(items) {
  ...
  return { nextItems: [...retained, ...guides], deletedNews, deletedBlog, guides };
}
