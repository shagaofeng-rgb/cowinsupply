...
export function renderSiteHeader(activePath = "") {
  ...
  return `<header class="site-header"><div class="container nav-wrap"><a class="brand" href="/"><img src="/cowin-assets/cowin-logo.png" alt="Cowin Supply logo"><span>Cowin Supply</span></a><nav class="main-nav" aria-label="Main navigation">${links}</nav><a class="btn btn-dark header-cta" href="/contact#quote">Get Wholesale Price</a><button class="nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false"><span></span><span></span><span></span></button></div></header>`;
}

export function renderSiteFooter() {
  return `<footer class="site-footer"><div class="container footer-grid"><div><h3>Cowin Supply</h3><p>Quzhou Qiying Import &amp; Export Co., Ltd.<br>No. 18, Sanxin Road, Lanjiang Sub-district, Lanxi City, Jinhua City, Zhejiang Province, China</p></div><div><h3>Products</h3><a href="/product">All Products</a><a href="/product/6000wsolttingmachine.html">Wall Chasers</a><a href="/product/LaserMeasuringDevicwithMultiFunction.html">Measuring Tools</a></div><div><h3>Resources</h3><a href="/news">News</a><a href="/blog">Blog</a><a href="/about">About</a><a href="/contact">Contact</a></div><div><h3>Contact</h3><a href="tel:+8617601255205">+8617601255205</a><a href="mailto:davidsha@cowinsupply.com">davidsha@cowinsupply.com</a></div></div><div class="footer-bottom"><div class="container">Copyright 2026 Cowin Supply. All rights reserved.</div></div></footer>`;
}
