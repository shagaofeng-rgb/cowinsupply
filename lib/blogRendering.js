...
import { normalizeCowinArticleLinks } from "@/lib/contentQuality";
...
function escapeHtml(value) { return normalizeCompanyText(value).replaceAll("&", "&amp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;"); }
