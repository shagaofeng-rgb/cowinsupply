    ...
    .map((item) => {
      ...
      return `<article class="news-card">
        ...
        <div>
          ...
          <p>${escapeHtml(cleanPlainText(item.summary || item.seoDescription || ""))}</p>
  ...
  return baseHtml({
    ...
    body: `<main class="news-shell">
      ...
      <article class="news-article">
        ...
        <p class="lead">${escapeHtml(cleanPlainText(article.summary || ""))}</p>
