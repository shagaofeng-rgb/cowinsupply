...
function baseHtml({ title, description, canonical, image = "/api/news/cover/cowin-news", structuredData = "", body }) {
  ...
  </head><body><header class="site-header"><a href="/" class="brand">Cowin Supply</a><nav><a href="/product">Products</a><a href="/news">News</a><a href="/blog">Blog</a><a href="/about">About</a><a href="/contact">Contact</a></nav></header>${body}<footer class="site-footer"><p>© Cowin Supply</p></footer><a class="whatsapp-float" href="https://wa.me/message/L6JST5GV37UYI1" target="_blank" rel="noopener noreferrer" aria-label="Chat with Cowin Supply on WhatsApp" title="Chat on WhatsApp"><img src="/cowin-assets/whatsapp.svg" alt=""></a></body></html>`;
}
