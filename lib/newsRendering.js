  ...
  return baseHtml({
    ...
    body: `<main class="news-shell">
      ...
      <article class="news-article">
        ...
        <p class="lead">${escapeHtml(safeArticleDescription(article))}</p>
...
function newsRefinementCss() { return `.news-shell{padding-top:52px}.news-hero{max-width:760px;margin-bottom:34px}.news-hero h1,.news-article h1{letter-spacing:0;color:#102a43}.eyebrow{color:#056889;letter-spacing:.08em}.news-card{border-color:#d9e2ec;border-radius:8px;box-shadow:0 1px 2px rgba(16,42,67,.04);transition:transform .18s ease,box-shadow .18s ease,border-color .18s ease}.news-card:hover{transform:translateY(-3px);border-color:#a8cdd9;box-shadow:0 14px 28px rgba(16,42,67,.1)}.news-card img,.article-cover{border-radius:6px}.news-card h2{color:#102a43}.news-card a,.product-card a,.news-pagination a{color:#056889}.meta{color:#627d98}.lead{color:#486581}.article-body{color:#243b53}.article-body h2,.source-box h2{color:#102a43}.takeaways,.source-box{border-color:#d9e2ec;border-radius:8px;background:#f6f9fc}.source-box dt{color:#334e68}.product-card{border-color:#d9e2ec;border-radius:8px;box-shadow:0 1px 2px rgba(16,42,67,.04)}.news-filters{padding:14px;border:1px solid #d9e2ec;border-radius:8px;background:#f6f9fc}.news-filters input,.news-filters select,.news-filters button{border-radius:6px}.news-filters input:focus,.news-filters select:focus{outline:3px solid rgba(8,126,164,.14);border-color:#087ea4}.news-filters button{background:#087ea4}.news-filters button:hover{background:#056889}.news-pagination span{color:#627d98}@media(max-width:720px){.news-shell{padding:32px 16px 52px}.news-card:hover{transform:none}.news-filters{padding:12px}}`; }
