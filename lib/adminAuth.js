...
function secret() {
  ...
  if (!value) throw new Error("ADMIN_JWT_SECRET is required for admin sessions.");
  return value;
}
...
export function isAdminAuthConfigured() {
  return Boolean(process.env.ADMIN_JWT_SECRET) && (isAdminPasswordConfigured() || Boolean(process.env.ADMIN_PASSWORD_HASH));
}
