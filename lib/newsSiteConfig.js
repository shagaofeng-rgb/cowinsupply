...
const SITE_CONFIGS = {
  [DEFAULT_SITE_ID]: {
    ...
    sources: {
      primaryWhitelist: ["construction-dive"],
      fallbackWhitelist: ["construction-dive"]
    },
    publishing: { requireFrontendVerification: true, productionEnabled: process.env.NEWS_AUTOMATION_ENABLED !== "false" }
  }
};
